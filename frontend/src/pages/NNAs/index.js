									...
									<Button.Group>
										<Popup
											...
											trigger={
												<Button
													icon
													onClick={() => setTypes('namedesc')}
													active={types === 'namedesc'}
												>
										...
										<Popup
											...
											trigger={
												<Button
													icon
													onClick={() => setTypes('nameasc')}
													active={types === 'nameasc'}
												>
										...
										<Popup
											...
											trigger={
												<Button
													icon
													onClick={() => setTypes('actdesc')}
													active={types === 'actdesc'}
												>
